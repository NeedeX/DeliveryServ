...
class CardProduct extends Component {
    ...
    render() {
        ...
        return (
            <TouchableOpacity
            activeOpacity={1}
            onPress={() => this.props.nav.navigate('ProductDetailView', { iProduct: this.props.iProduct, idInCart: this.props.idInCart, routeGoBack: 'inCart', iCategories: this.props.iCategories})}
